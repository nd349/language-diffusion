...
while train:
    ...
    for batch in train_dataloader:
        ...
        # Multiplying by query_mask to remove masking of prompt tokens
        ...
        # In pretrain we had equal length of examples, but in supervised fine tuning the answer length can vary. Therefore, we also divide the loss by answer length.
        answer_len = query_mask.sum(dim=1, keepdim=True)
